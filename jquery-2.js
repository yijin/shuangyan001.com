...
<div style="width:1000px; margin:0 auto; padding-top:45px;">
  <div style="width:600px; font-size:16px; line-height:25px;padding-left:400px; padding-top:0px;">
      ...
      <div>
	      <a href="javascript:if(confirm('http://bbs.safedog.cn/thread-60693-1-1.html?from=stat  \n\n该文件无法用 Teleport Ultra 下载, 因为 它是一个域或路径外部被设置为它的启始地址的地址。  \n\n你想在服务器上打开它?'))window.location='http://bbs.safedog.cn/thread-60693-1-1.html?from=stat'" tppabs="http://bbs.safedog.cn/thread-60693-1-1.html?from=stat" target="_blank" style="color:#139ff8; font-size:16px; text-decoration:none">站长请点击</a>
  ...
  <div style="width:900px; height:600px; margin:0 auto;">
   <iframe allowtransparency=" true" src="javascript:if(confirm('http://404.safedog.cn/sitedog_stat_new.html  \n\n该文件无法用 Teleport Ultra 下载, 因为 它是一个域或路径外部被设置为它的启始地址的地址。  \n\n你想在服务器上打开它?'))window.location='http://404.safedog.cn/sitedog_stat_new.html'" tppabs="http://404.safedog.cn/sitedog_stat_new.html"   frameborder="no" border="0" scrolling="no" style="width:980px; height:600px;" ></iframe>
 </div>
  </div>
</div>
</body>
